          ...
          <div class="card wizard-card" id="wizard">
            <form action="" method="">
                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                      <div class="col-sm-4 col-sm-offset-2">
                        <div class="choice" data-toggle="wizard-radio">
                          <input type="radio" name="budget" value="Design">
                ...
                <div class="tab-pane" id="trade">
                  ...
                  <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                      <div class="col-sm-4 col-sm-offset-2">
                        <div class="choice" data-toggle="wizard-radio">
                          <input type="radio" name="trade" value="Design">
                          <div class="card card-checkboxes card-hover-effect">
                            <p>Yes</p>
                          </div>
                        </div>
                ...
                <div class="tab-pane" id="credit">
                  ...
                  <div class="row">
                    <div class="col-sm-10 col-sm-offset-1">
                      <div class="col-sm-4">
                        <div class="choice" data-toggle="wizard-radio">
                          <input type="radio" name="credit" value="Design">
                          <div class="card card-checkboxes card-hover-effect">
                            <p>Good (Over 650)</p>
                          </div>
                        </div>
                ...
                <div class="tab-pane" id="status">
                  ...
                  <div class="row">
                    <div class="col-sm-10 col-sm-offset-1">
                      <div class="col-sm-4">
                        <div class="choice" data-toggle="wizard-radio">
                          <input type="radio" name="status" value="Design">
                          <div class="card card-checkboxes card-hover-effect">
                            <p>Employed</p>
                          </div>
                        </div>
              ...
              <div class="wizard-footer">
                ...
                <input type="button" class="btn btn-finish btn-fill btn-success btn-wd" name="finish" value="Get Pre-Approval" data-toggle="modal" data-target="#approvalModal" />
